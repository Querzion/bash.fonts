...
install_font() {
  ...
  echo -e "${CYAN} Do you want to install $font_name? ${NC} (y/n)"
  read install_font
...
install_fonts_detailed() {
  ...
  echo -e "${CYAN} Do you want to install fonts to your system? ${NC} (y/n)"
  read install_fonts
  if [[ $install_fonts =~ ^[nN]$ ]]; then
    ...
    echo -e "${CYAN} Do you want to install all $font_count font packages? ${NC} (y/n)"
